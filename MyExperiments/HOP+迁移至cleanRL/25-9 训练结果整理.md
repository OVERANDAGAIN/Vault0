...
可以把 ToDo 部分润色成更正式、条理清晰的研究任务列表：

---

## **ToDo**

* **单智能体对照实验**：设置 1 个学习型智能体与 3 个 rule-based 智能体共同交互，通过简化环境配置来定位问题，观察在这种条件下策略是否能够学到合作行为，以便更直观地分析训练稳定性与模块功能。
* **PPO Baseline 复现实验**：针对 PPO baseline 的训练过程，进一步更换随机种子并增加多组实验次数，验证结果的稳定性与一致性，从而排除单次实验偶然性带来的影响，并为 HOP+ 的表现提供可靠对照。

---

要不要我帮你把 **Todo 部分再细化成“短期任务 / 中期任务 /长期任务”** 这种分层形式，方便你在周报里展现计划性？
